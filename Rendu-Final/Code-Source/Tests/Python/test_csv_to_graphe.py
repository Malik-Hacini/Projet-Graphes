...
def test_traitement_information():
    ...
    assert traitement_information(l,-1)==(['D','F'],{('D','F')},[('D',60),('F',30)],30)
    assert traitement_information(l,1)==(['D','F'],{('D','F')},[('D',30),('F',21)],21)
    assert traitement_information(l,2)==(['D','F'],{('D','F')},[('D',14),('F',14)],14)
    assert traitement_information(l,3)==(['D','F'],{('D','F')},[('D',7),('F',7)],7)
    ...
    assert traitement_information(l,-1)==(['D','I1','I2','I3','F'],{('D','I1'),('D','I2'),('D','I3'),('I1','F'),('I2','F'),('I3','F')},[('D',60),('I1',30),('I2',90),('I3',60),('F',60)],60)
    
def test_csv_to_graph():
    nom_test="test_csv_to_graph"
    output=[(['D', 'I1', 'I2', 'F'], {('D', 'I1', 30.0), ('D', 'I2', 30.0), ('I1', 'F', 14.0), ('I2', 'F', 1.0)}, 1.0),#Sans suivi
(['D', 'I1', 'I2', 'F'], {('D', 'I1', 60.0), ('D', 'I2', 60.0), ('I1', 'F', 21.0), ('I2', 'F', 2.0)}, 0),#S0
